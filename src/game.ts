...
// export type Move = 'C' | 'B'; // 'C' for Cooperate, 'B' for Betray
...
// /**
//  * JSON-friendly game state. The index signature lets this object qualify as a JSON object.
//  */
...
//   mode: 'bot' | 'player';
//   [key: string]: string | number | Move | BotStrategy | 'bot' | 'player';
// }
...
//   constructor(mode: 'bot' | 'player', botStrategy?: BotStrategy) {
//     this.mode = mode;
//     if (mode === 'bot') {
//       this.botStrategy = botStrategy || this.randomBotStrategy();
//     } else {
//       // For player-vs-player mode, assign a default (not used in demo).
...
//   playRound(playerMove: Move): { playerMove: Move; opponentMove: Move; score: Score } {
//     let opponentMove: Move;
//     if (this.mode === 'bot') {
//       opponentMove = this.getBotMove(playerMove);
//       this.lastOpponentMove = opponentMove;
//     } else {
//       // For demo purposes, simulate multiplayer with bot behavior.
//       opponentMove = this.getBotMove(playerMove);
//       this.lastOpponentMove = opponentMove;
//     }
...
//   getWinner(): string {
//     if (this.playerScore > this.opponentScore) return 'Player wins!';
//     if (this.playerScore < this.opponentScore) return 'Opponent wins!';
//     return "It's a tie!";
//   }
